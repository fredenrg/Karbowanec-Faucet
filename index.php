		...
		<div id="login-form">
			...
			<fieldset>
				...
				<?php                  
					...
					$totalKRB =  ($balanceDisponible+$lockedBalance)/$dividirEntre;
				...
				?>
							...
							<a target="_blank" href="https://explorer.karbo.io/?hash=<?php echo $_GET['txid']; ?>#blockchain_transaction">Перевірити у блокчейні</a>
							</div>
				<?php } else 
          ...
          <p style="font-size:10px;">Пожертвуйте карбованці для підтримки цього крану. <br>Адреса: <?php echo $faucetAddress; ?><br>&#169; 2015 Faucet by <a href="https://github.com/Ratnet/Bytecoin-Faucet" target="_blank">Ratnet</a><br />&#169; 2016 <a href="https://github.com/seredat/Karbowanec-Faucet" target="_blank">Seredat</a><br />&#169; 2018 <a href="https://github.com/Looongcat/karbo-faucet-frontend" target="_blank">Looongcat</a><br /></p></center>
